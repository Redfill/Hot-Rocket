...
void main()
{
    ...
    vec3 Mapping_Vector_res_wt = Geometry_Position_res_wt * vec3(0.89999997615814208984375, 0.800000011920928955078125, 1.0);
    vec4 ImageTexture_store = texture(ImageTexture, vec2(Mapping_Vector_res_wt.x, 1.0 - Mapping_Vector_res_wt.y));
    vec3 _89 = pow(ImageTexture_store.xyz, vec3(2.2000000476837158203125));
    ImageTexture_store = vec4(_89.x, _89.y, _89.z, ImageTexture_store.w);
    ...
    {
        _161 = octahedronWrap(n.xy);
    }
    n = vec3(_161.x, _161.y, n.z);
